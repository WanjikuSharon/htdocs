...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in KES</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is KES" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
